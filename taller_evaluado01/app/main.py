...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        description="In-Memory CRUD API for the Student Entity and Its Pets (Pet)",
        version="1.0",
    )
    ...
    async def http_exception_handler(request: Request, exc: StarletteHTTPException):
        return JSONResponse(
            ...
            content={
                ...
                "message": exc.detail if isinstance(exc.detail, str) else "Error processing the request",
